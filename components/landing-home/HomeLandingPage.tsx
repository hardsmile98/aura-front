...
import { StarIcon, CheckMarkIcon } from '@/components/icons';
...
/** Step 1: Quiz / Form - clipboard with checklist */
function QuizClipboardIcon({ className }: { className?: string }) {
  return (
...
/** Step 3: Document / Readings - scroll or document */
function DocumentReadIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
...
/** Step 4: Chat / 1-on-1 guidance - message with users */
function ChatUserIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <main className="flex-1">
          ...
          <div className={containerSectionClass}>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 md:gap-12">
              <div className="p-4 sm:p-6 rounded-2xl bg-zinc-50 border border-zinc-100">
                ...
                <h3 className="text-base sm:text-lg font-semibold text-zinc-900 mb-1.5 sm:mb-2">{t.feature1Title}</h3>
                <p className="text-zinc-600 text-sm leading-relaxed">{t.feature1Desc}</p>
              </div>
              <div className="p-4 sm:p-6 rounded-2xl bg-zinc-50 border border-zinc-100">
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-violet-100 flex items-center justify-center mb-3 sm:mb-4 shrink-0">
                  <UsersIcon className="w-5 h-5 sm:w-6 sm:h-6 text-violet-600" />
                </div>
                <h3 className="text-base sm:text-lg font-semibold text-zinc-900 mb-1.5 sm:mb-2">{t.feature2Title}</h3>
                <p className="text-zinc-600 text-sm leading-relaxed">{t.feature2Desc}</p>
              </div>
              <div className="p-4 sm:p-6 rounded-2xl bg-zinc-50 border border-zinc-100">
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-violet-100 flex items-center justify-center mb-3 sm:mb-4 shrink-0">
                  <HeartIcon className="w-5 h-5 sm:w-6 sm:h-6 text-violet-600" />
                </div>
                <h3 className="text-base sm:text-lg font-semibold text-zinc-900 mb-1.5 sm:mb-2">{t.feature3Title}</h3>
                <p className="text-zinc-600 text-sm leading-relaxed">{t.feature3Desc}</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-10 sm:py-14 md:py-24 bg-zinc-50">
          <div className={containerSectionClass}>
            ...
            <div className="relative flex flex-col md:flex-row md:items-start md:justify-between gap-0 md:gap-4 mb-6 md:mb-8 max-w-4xl mx-auto">
              {/* Vertical line on mobile - connects icon centers */}
              <div className="absolute left-6 top-6 bottom-6 w-0.5 bg-violet-600 md:hidden" aria-hidden />
              <div className="absolute left-[15%] right-[15%] top-6 h-0.5 bg-violet-600 hidden md:block" aria-hidden />
              {[
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
              <div className="bg-white rounded-2xl p-4 sm:p-6 shadow-sm border border-zinc-100">
                ...
                <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-zinc-900 mb-0.5 sm:mb-1">{t.statsRecommend}</div>
                <p className="text-zinc-600 text-xs sm:text-sm">{t.statsCard1Label}</p>
              </div>
              <div className="bg-white rounded-2xl p-4 sm:p-6 shadow-sm border border-zinc-100">
                <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-lg bg-violet-100 flex items-center justify-center mb-3 sm:mb-4 shrink-0">
                  <StarIcon className="w-4 h-4 sm:w-5 sm:h-5 text-violet-600" />
                </div>
                <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-zinc-900 mb-0.5 sm:mb-1">{t.statsReadings}</div>
                <p className="text-zinc-600 text-xs sm:text-sm">{t.statsCard2Label}</p>
              </div>
              <div className="bg-white rounded-2xl p-4 sm:p-6 shadow-sm border border-zinc-100">
                <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-lg bg-violet-100 flex items-center justify-center mb-3 sm:mb-4 shrink-0">
                  <StarIcon className="w-4 h-4 sm:w-5 sm:h-5 text-violet-600" />
                </div>
                <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-zinc-900 mb-0.5 sm:mb-1">{t.statsStars}</div>
                <p className="text-zinc-600 text-xs sm:text-sm">{t.statsCard3Label}</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-10 sm:py-14 md:py-24 bg-white">
          <div className={containerSectionClass}>
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-zinc-900 mb-6 md:mb-8">{t.trialTitle}</h2>
            <div className="flex flex-col md:flex-row bg-white rounded-2xl border border-zinc-200 shadow-sm overflow-hidden">
              <div className="flex-1 p-4 sm:p-6 md:p-8 grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-5 md:gap-6 md:border-r border-zinc-200">
                <div className="flex gap-2 sm:gap-3">
                  ...
                  <p className="text-zinc-600 text-xs sm:text-sm leading-relaxed">{t.trialBenefit1}</p>
                </div>
                <div className="flex gap-2 sm:gap-3">
                  <CheckMarkIcon className="w-4 h-4 sm:w-5 sm:h-5 text-violet-600 shrink-0 mt-0.5" />
                  <p className="text-zinc-600 text-xs sm:text-sm leading-relaxed">{t.trialBenefit2}</p>
                </div>
                <div className="flex gap-2 sm:gap-3">
                  <CheckMarkIcon className="w-4 h-4 sm:w-5 sm:h-5 text-violet-600 shrink-0 mt-0.5" />
                  <p className="text-zinc-600 text-xs sm:text-sm leading-relaxed">{t.trialBenefit3}</p>
                </div>
                <div className="flex gap-2 sm:gap-3">
                  <CheckMarkIcon className="w-4 h-4 sm:w-5 sm:h-5 text-violet-600 shrink-0 mt-0.5" />
                  <p className="text-zinc-600 text-xs sm:text-sm leading-relaxed">{t.trialBenefit4}</p>
                </div>
              </div>
                ...
                items={[
                  ...
                  },
                  {
                    ...
                    answer: (
                      <>
                        {t.faq5A1}
                        <Link href={`/${locale}/privacy-notice/`}>{t.faq5Link}</Link>
                        {t.faq5A2}
                      </>
                    ),
                  },
        ...
        <div className={containerSectionClass}>
          <div className="flex flex-col md:flex-row justify-between gap-6 sm:gap-8 mb-6 sm:mb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8">
              <div>
                <h4 className="font-semibold text-white mb-2">{t.footerCustomerSupport}</h4>
                <p className="text-sm">{t.footerSupport}</p>
              </div>
              <div>
                <h4 className="font-semibold text-white mb-2">{t.footerLegal}</h4>
                <div className="flex flex-col gap-2">
                  <Link href={`/${locale}/privacy-notice/`} className="text-sm hover:text-white transition-colors">
                    {t.footerPrivacy}
                  </Link>
                  <Link href={`/${locale}/eula/`} className="text-sm hover:text-white transition-colors">
                    {t.footerTerms}
                  </Link>
                </div>
              </div>
          ...
          <div className="pt-6 sm:pt-8 border-t border-zinc-700 flex flex-col md:flex-row justify-between items-center gap-3 sm:gap-4">
            <p className="text-xs text-zinc-500 text-center md:text-left">{t.footerCopyright}</p>
            <div className="flex gap-4 text-sm">
              <Link href="/en/" className={`transition-colors ${locale === 'en' ? 'text-white font-medium' : 'hover:text-white'}`}>
                English
              </Link>
              <Link href="/ru/" className={`transition-colors ${locale === 'ru' ? 'text-white font-medium' : 'hover:text-white'}`}>
                Русский
              </Link>
            </div>
          </div>
