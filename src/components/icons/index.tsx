/** Centralized icons - single source of truth */
...
export function HoroscopeIcon({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function ExpertIcon({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
/** Landing / Home icons - 3 filled stars in golden yellow */
export function SparklesIcon({ className }: { className?: string }) {
  return (
    <svg
      ...
      <path d="M5 16l.5 1.5L7 18l-1.5.5L5 20l-.5-1.5L3 18l1.5-.5L5 16z"></path>
    </svg>
  );
}
...
export function QuizClipboardIcon({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function DocumentReadIcon({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function ChatUserIcon({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function BabyIcon({ className }: { className?: string }) {
  return (
    <svg
      ...
      <path
        fill="currentColor"
        d="M22.12 10.293a10.67 10.67 0 0 0-5.037-6.172 3.52 3.52 0 0 0 1.269-2.715V.703h-1.407v.703c0 .922-.582 1.722-1.44 2.01q-.469-.165-.95-.284a3.51 3.51 0 0 0 .972-2.429V0h-1.406v.703c0 1.17-.951 2.121-2.121 2.121-2.368 0-4.606.764-6.474 2.21a10.67 10.67 0 0 0-3.646 5.259A3.51 3.51 0 0 0 0 13.413a3.54 3.54 0 0 0 2.005 3.182c.748 1.98 2.182 3.823 4.069 5.216C7.958 23.202 10.118 24 12 24s4.042-.798 5.926-2.189c1.887-1.393 3.321-3.235 4.069-5.216A3.54 3.54 0 0 0 24 13.412a3.51 3.51 0 0 0-1.88-3.12m-14.356 2.41a.71.71 0 0 0-.71.71H5.649c0-1.167.95-2.116 2.116-2.116s2.115.949 2.115 2.115H8.473a.71.71 0 0 0-.71-.709M12 19.576a2.825 2.825 0 0 1-2.821-2.821h1.406c0 .78.635 1.415 1.415 1.415s1.415-.635 1.415-1.415h1.406A2.825 2.825 0 0 1 12 19.576m4.945-6.164a.71.71 0 0 0-1.418 0h-1.406c0-1.166.949-2.115 2.115-2.115s2.116.949 2.116 2.115z"></path>
    </svg>
  );
}

/** Horoscope direction icons */
...
export function renderInfoSlideIcon(
  name: InfoSlideIconName,
  className?: string,
) {
