              ...
              <div className="relative order-1 md:order-2 flex justify-center md:justify-end">
                <div className="relative w-full max-w-sm sm:max-w-md aspect-[4/4] md:max-w-none md:w-full md:aspect-[4/3]">
                  <img
                    ...
                    alt=""
                    className="absolute inset-0 w-full h-full object-contain object-left z-0 scale-110 origin-left"
                  />
                  <img
                    src="/img/head-image.webp"
                    alt=""
                    className="absolute inset-0 w-full h-full object-contain object-center md:object-right relative z-10"
                  />
                </div>
              </div>
            </div>
                ...
                items={[
                  ...
                  { question: t.faq2Q, answer: t.faq2A },
                  {
                    ...
                    answer: (
                      <>
                        {t.faq3A1}
                        <Link to={`/${locale}/eula`} target="_blank">{t.faq3Link}</Link>
                        {t.faq3A2}
                      </>
                    ),
                  },
                  {
                    ...
                    answer: (
                      <>
                        {t.faq4A1}
                        <Link to={`/${locale}/eula`} target="_blank">{t.faq4Link}</Link>
                        {t.faq4A2}
                      </>
                    ),
                  },
                  {
                    ...
                    answer: (
                      <>
                        {t.faq5A1}
                        <Link to={`/${locale}/privacy-notice`} target="_blank">
                          {t.faq5Link}
                        </Link>
                        {t.faq5A2}
                      </>
